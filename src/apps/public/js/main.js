...
async function listAvailableTokens() {
    ...
    tokens = {
        ...
        '0x9a5dAF7E263bc29ed05456Dc5c5136270715fFEd': {
            'symbol': 'MEME',
            'address': '0x9a5dAF7E263bc29ed05456Dc5c5136270715fFEd',
...
$(document).ready(() => {
    ...
    document.getElementById("submit_add_liquidity").onclick = (async () => {
        console.log(liquidityPair.from.address);
        console.log(liquidityPair.to.address);
        console.log(owner)
        console.log('------')
        factory =  new web3.eth.Contract(factoryABI, mumbaiQuickSwapFactoryContract);
        // console.log(await factory.methods.allPairs().call());
        console.log(await factory.methods.getPair(liquidityPair.from.address, liquidityPair.to.address).call());

        contract = new web3.eth.Contract(routerAbi, mumbaiQuickSwapRouterContract);
